	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				String selector = " selected=\"selected\"";
				String value1 = "1";
				String value2 = "2";
				if(paymentOption.equals("1")){
					System.out.println("현금구매입니다.");
					value1 = selector;
				}
				if(paymentOption.equals("2")){
					System.out.println("신용구매입니다.");
					value2 = selector;
				}
				%>
				
				<option value="1"<%=value1 %>>현금구매</option>
				<option value="2"<%=value2 %>>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="receiverAddr" class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="<%=user.getAddr()!=null ? user.getAddr() : "연락처가 없음" %>" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
